...
{api.updatePosition(event,true);}};},100);})
    ...
    $.fn.qtip.log={error:function(){return this;}};$.fn.qtip.constants={};$.fn.qtip.defaults={content:{prerender:false,text:false,url:false,data:null,title:{text:false,button:false}},position:{target:false,corner:{target:'bottomRight',tooltip:'topLeft'},adjust:{x:0,y:0,mouse:true,screen:false,scroll:true,resize:true},type:'absolute',container:false},show:{when:{target:false,event:'mouseover'},effect:{type:'fade',length:100},delay:140,solo:false,ready:false},hide:{when:{target:false,event:'mouseout'},effect:{type:'fade',length:100},delay:0,fixed:false},api:{beforeRender:function(){},onRender:function(){},beforePositionUpdate:function(){},onPositionUpdate:function(){},beforeShow:function(){},onShow:function(){},beforeHide:function(){},onHide:function(){},beforeContentUpdate:function(){},onContentUpdate:function(){},beforeContentLoad:function(){},onContentLoad:function(){},beforeTitleUpdate:function(){},onTitleUpdate:function(){},beforeDestroy:function(){},onDestroy:function(){},beforeFocus:function(){},onFocus:function(){}}};$.fn.qtip.styles={defaults:{background:'white',color:'#111',overflow:'hidden',textAlign:'left',width:{min:0,max:250},padding:'5px 9px',border:{width:1,radius:0,color:'#d3d3d3'},tip:{corner:false,color:false,size:{width:13,height:13},opacity:1},title:{background:'#e1e1e1',fontWeight:'bold',padding:'7px 12px'},button:{cursor:'pointer'},classes:{target:'',tip:'qtip-tip',title:'qtip-title',button:'qtip-button',content:'qtip-content',active:'qtip-active'}},cream:{border:{width:3,radius:0,color:'#F9E98E'},title:{background:'#F0DE7D',color:'#A27D35'},background:'#FBF7AA',color:'#A27D35',classes:{tooltip:'qtip-cream'}},light:{border:{width:3,radius:0,color:'#E2E2E2'},title:{background:'#f1f1f1',color:'#454545'},background:'white',color:'#454545',classes:{tooltip:'qtip-light'}},dark:{border:{width:3,radius:0,color:'#303030'},title:{background:'#404040',color:'#f3f3f3'},background:'#505050',color:'#f3f3f3',classes:{tooltip:'qtip-dark'}},red:{border:{width:3,radius:0,color:'#CE6F6F'},title:{background:'#f28279',color:'#9C2F2F'},background:'#F79992',color:'#9C2F2F',classes:{tooltip:'qtip-red'}},green:{border:{width:3,radius:0,color:'#A9DB66'},title:{background:'#b9db8c',color:'#58792E'},background:'#CDE6AC',color:'#58792E',classes:{tooltip:'qtip-green'}},blue:{border:{width:3,radius:0,color:'#ADD9ED'},title:{background:'#D0E9F5',color:'#5E99BD'},background:'#E5F6FE',color:'#4D9FBF',classes:{tooltip:'qtip-blue'}}};})(jQuery);((function($,window){var CenterAlert=CenterAlert||{};CenterAlert=$.extend({show:function(divObj){var windowWidth=$(window).width();var windowHeight=$(window).height();var scrollLeft=$(document).scrollLeft();var scrollTop=$(document).scrollTop();var divWidth=divObj.width();var divHeight=divObj.height();var yangyangWidth=1000;var yangyangleft=(windowWidth-yangyangWidth)/2;var left=(windowWidth-divWidth)/2;var top=(windowHeight-divHeight)/2+scrollTop;if(left<0)
    left=scrollLeft;if(top<0)
    top=scrollTop;divObj.css("position","absolute");divObj.css("left",left+"px");divObj.css("top",top+"px");divObj.css("display","block");},hidden:function(divObj){divObj.css("display","none");}},CenterAlert);var BackMask=BackMask||{};BackMask=$.extend({show:function(maskObj){var maskWidth=$(document).width();var maskHeight=$(document).height();maskObj.css("width",maskWidth+"px");maskObj.css("height",maskHeight+"px");maskObj.show();},hidden:function(maskObj){maskObj.hide();}},BackMask);TM.CenterAlert=CenterAlert;TM.BackMask=BackMask;})(jQuery,window));((function($,window){var Loading=Loading||{};Loading.init=Loading.init||{};Loading.init=$.extend({show:function(opts){TM.BackMask.show($(".LoadingMask"));var divObj=$(".WaitingForLoadingDiv");TM.CenterAlert.show(divObj);$('.mengban').css("display",'block');},hidden:function(){var divObj=$(".WaitingForLoadingDiv");TM.CenterAlert.hidden(divObj);TM.BackMask.hidden($(".LoadingMask"));$('.mengban').css("display",'none');}},Loading.init);TM.Loading=Loading;})(jQuery,window));